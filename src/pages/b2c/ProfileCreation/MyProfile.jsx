...
const outfitOptions = [
  ...
  },
  {
    ...
    staticImage: 'https://res.cloudinary.com/doiezptnn/image/upload/v1763188140/ChatGPT_Image_Nov_15_2025_11_58_37_AM_cnzfyj.png',
    garmentUrl: 'https://res.cloudinary.com/doiezptnn/image/upload/v1763188140/ChatGPT_Image_Nov_15_2025_11_58_37_AM_cnzfyj.png'  // ← REAL URL
  },
  {
    id: 'anarkali',
    label: 'Anarkali',
  ...
  const renderStep = () => {
    switch (currentStep) {
      ...
      case 2:
        return (
          <div className="max-w-2xl mx-auto px-6 py-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-2">Which body shape describes you best?</h2>
            <p className="text-[#45556C] mb-8">This helps us show you how clothes will fit your unique silhouette.</p>
      ...
      case 4:
        return (
          <div className="max-w-2xl mx-auto px-6 py-8">
            ...
            <p className="text-[#45556C] mb-8">These details help personalize your virtual avatar.</p>
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="bg-white border-b">
        <div className="max-w-4xl mx-auto px-6 py-4">
          <div className="text-sm text-gray-600 mb-2">{currentStep + 1} of {totalSteps}</div>
