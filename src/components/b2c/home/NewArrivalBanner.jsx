            ...
            <div className="max-w-[1400px] mx-auto">
                <div className="w-full rounded-[30px] overflow-hidden bg-gradient-to-r from-[#EEEAF4] to-[#F1E1EB] p-6 md:p-12 flex flex-col lg:flex-row items-center gap-10">
                    ...
                    <div className="w-full lg:w-1/2 flex justify-center lg:justify-start gap-4 h-[300px] md:h-[400px]">
                        <div className="w-1/3 h-full rounded-xl overflow-hidden shadow-md">
                            <img src={img1} alt="New Arrival 1" className="w-full h-full object-cover transform hover:scale-105 transition-transform duration-500" />
                        </div>
                        <div className="w-1/3 h-full rounded-xl overflow-hidden shadow-md">
                            <img src={img2} alt="New Arrival 2" className="w-full h-full object-cover transform hover:scale-105 transition-transform duration-500" />
                        </div>
                        <div className="w-1/3 h-full rounded-xl overflow-hidden shadow-md">
                            <img src={img3} alt="New Arrival 3" className="w-full h-full object-cover transform hover:scale-105 transition-transform duration-500" />
                        </div>
                    </div>
