  ...
  return (
    <div className="relative group overflow-hidden">
      <img
        ...
        className={`w-full object-fit transition-transform duration-500 group-hover:scale-110 cursor-pointer ${
          size === "large" ? "h-[450px] md:h-[510px]" : "h-[300px] md:h-[350px]"
        }`}
      />
...
const BestProducts = ({ products, columns, buttonText }) => {
  return (
    <section className="bg-white mt-4">
      <div
        className="container mx-auto px-3 sm:px-3 md:px-4 lg:px-10 "
      ...
      >
        ...
        <div className="hidden md:grid md:grid-cols-3 gap-4 md:gap-6">
          ...
          <div
            className={`md:col-span-${columns === 2 ? 1 : 2} grid grid-cols-${columns === 2 ? 1 : 2} gap-4`}
          >
        ...
        <div className="grid grid-cols-2 xs:grid-cols-2 md:hidden gap-3">
